...
from .models import Consultas, Documento
...
def minhas_consultas(request):
    #if request.method == "GET":
    minhas_consultas = Consultas.objects.filter(paciente=request.user).filter(data_aberta__data__gte=datetime.now())
